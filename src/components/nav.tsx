...
export function Nav() {
  ...
  return (
    <>
      ...
      <nav className="sticky top-0 z-50 bg-[rgba(254,254,254,0.95)] backdrop-blur-xl border-b border-gray-100 px-4 md:px-10 py-2.5 md:py-3.5 hidden md:flex justify-between items-center">
      ...
      {/* Mobile header — logo only, shown below md */}
      <header className="sticky top-0 z-50 bg-[rgba(254,254,254,0.95)] backdrop-blur-xl border-b border-gray-100 px-4 py-2 flex items-center md:hidden">
        <Link href="/" className="flex items-center gap-2.5 no-underline">
          <div className="w-8 h-8 rounded-[9px] bg-gradient-to-br from-indigo-500 to-violet-400 flex items-center justify-center shadow-[0_2px_8px_rgba(99,102,241,0.25)]">
            <svg viewBox="0 0 46 32" fill="none" className="w-[18px] h-[18px]">
              <rect x="0" y="6" width="46" height="26" rx="5" stroke="#fff" strokeWidth="2.5" fill="none" />
              <path d="M7 6V3a5 5 0 015-5h22a5 5 0 015 5v3" stroke="#fff" strokeWidth="2.5" fill="none" />
              <circle cx="36" cy="19" r="4" stroke="#fff" strokeWidth="2" fill="none" />
              <line x1="36" y1="16.5" x2="36" y2="21.5" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" />
          ...
          <span className="font-[family-name:var(--font-caveat)] text-xl font-semibold text-gray-800 leading-none">
            mis finanzas
          </span>
        </Link>
      </header>
